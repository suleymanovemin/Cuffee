...
function Checkout({ basket, products }) {
  //   console.log(basket);
  return (
    <div className="container">
      <div className="checkOut">
            ...
            <div className="Yorder">
              <table>
                <tbody>
                    ...
                    ? basket?.map((a) => {
                        ...
                        return (
                          <tr key={a?.id}>
                            <td>
                              <div>
                                <div className="chectOutProdImg">
                                  <img src={prod?.image[0]} alt="" />
                                  <div className="chectOutProdCount">
                                    {a.count}
                                  </div>
                                </div>
                                <div>
                  ...
                  <tr className="chectOutProdTotal">
                    <td>
                    Ümumi:
                    </td>
                    <td>
              ...
              <br />
              <div>
                <input type="radio" name="dbt" value="dbt" /> Direct Bank
                Transfer
              </div>
              <p>
        ...
        <div className="checkOutProdList"></div>
      </div>
    </div>
  );
}
