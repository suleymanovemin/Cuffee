          ...
          <div onClick={() => viewProduct(a.id)} key={a.id} className="product">
            <div className="productImage">
              ...
              <div className="productIcon">
                <ul>
                  <li onClick={() => visibleAddModal(a.id)} className="toolTip">
                  ...
                  <li onClick={() => addToFavorite(a.id)} className="toolTip">
                    <div className="toolTipText">Seçilmişlər</div>
                    <p>
                      {favorites.find((product) => product.id === a.id) ? <i className="fa-solid fa-heart"></i>
                      :<svg
                      xmlns="http://www.w3.org/2000/svg"
                      height="48"
                      viewBox="0 96 960 960"
